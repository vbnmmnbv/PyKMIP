...
class KmipEngine(object):
    ...
    def _process_revoke(self, payload):
        ...
        # TODO: (1) need to set Compromise Date attribute or Deactivation Date
        # attribute, (2) The revoke (KMIP1.2 4.20)  doesn't say anything about
        # the state transition permission, but the state (KMIP1.2 3.22) diagram
        # does show that not all states can transit to "Deactivated" or
        # "Compromised". So what's the right way?
